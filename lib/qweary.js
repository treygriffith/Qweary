...
// util.inherits obliterates the prototype, so we can't add prototype methods until after
// the mongoose.Document inheritance is established.
function addToPrototype(Qweary) {
...
module.exports = function(mongoose) {
	...
	// extend the prototype to include our custom methods
	return addToPrototype(Qweary);
};