...
Qweary.prototype.__proto__ = mongoose.Document.prototype; 
...
Qweary.prototype.inspect = function(depth) {
	return util.inspect(this.toObject(), undefined, 10); //this is old way that arguments are ordered, and it's current for Node 0.8.x
};
